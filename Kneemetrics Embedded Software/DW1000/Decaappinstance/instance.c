...
uint64 anchorAddressListNearest[1] =
{
		0xDECA0201DECA0202 ,       // Second anchor// Third anchor
} ;
// -------------------------------------------------------------------------------------------------------------------
// Functions
// -------------------------------------------------------------------------------------------------------------------
...
//#endif
        ...
        case TA_TXBLINK_WAIT_SEND :
            {
#if ENABLE_PRINTF
            	printf("\r\n Test App Run TA_TXBLINK_WAIT_SEND");
#endif
        ...
        case TA_TXRANGINGINIT_WAIT_SEND :
                {
#if ENABLE_PRINTF
                	printf("\r\n Test App Run TA_TXRANGINGINIT_WAIT_SEND");
#endif
        ...
        case TA_TXPOLL_WAIT_SEND :
            {
#if ENABLE_PRINTF
            	printf("\r\n Test App Run TA_TXPOLL_WAIT_SEND");
#endif
#if (DR_DISCOVERY == 1)
...
#if ENABLE_PRINTF
        	printf("\r\n Test App Run TA_TXRESPONSE_WAIT_SEND");
#endif
				...
				//payload (send 2 anchor addresses to poll

			//	inst->msg.messageData[9] = 0x9;//anchorAddressListNearest[0]; //address to send
			//	sprintf(stri, "%x",inst->msg.messageData);//prepare string to be sent through uart
			//				USART_puts(USART6,stri);
        ...
        case TA_TXFINAL_WAIT_SEND :
            {
#if ENABLE_PRINTF
            	printf("\r\n Test App Run TA_TXFINAL_WAIT_SEND");
#endif
...
#if ENABLE_PRINTF
            	printf("\r\n Test App Run TA_TXREPORT_WAIT_SEND");
#endif
...
#else
    instance_data[instance].sendTOFR2Tag = 1;//it was 0
#endif
...
#if ENABLE_PRINTF
    printf("\r\n Instance_Init_S Added testapprun_s");
#endif
